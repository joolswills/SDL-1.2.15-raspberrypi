...
CC      = gcc
INCLUDE = -I./include
CFLAGS  = -O3 -mfpu=vfp -mfloat-abi=hard -march=armv6j 
EXTRA_CFLAGS = -I./include -D_GNU_SOURCE=1 -fvisibility=hidden  -I/opt/vc/include -I/opt/vc/include/interface/vcos/pthreads -I/opt/vc/include/interface/vmcs_host/linux -D_REENTRANT -DHAVE_LINUX_VERSION_H -Wall
LDFLAGS = 
